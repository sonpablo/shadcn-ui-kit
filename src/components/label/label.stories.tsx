    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
      ...
      <div className="light border-border rounded-lg border-2 p-8">
        <div className="bg-primary/10 mb-6 rounded-md p-4">
          ...
          <p className="text-muted-foreground text-sm">Labels in light theme</p>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="light-premium">
              <Star className="size-4" />
              Premium
            </Label>
            <Input id="light-premium" type="text" placeholder="Enter code" />
          </div>

          <div className="flex flex-col gap-2">
            <Label htmlFor="light-required">
              Required Field
              <span className="text-destructive">*</span>
            </Label>
            <Input
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="light-error">
              With Error
              <AlertCircle className="text-destructive size-4" />
            </Label>
            <Input id="light-error" type="text" aria-invalid />
          </div>

          <div className="flex flex-col gap-2">
            <Label htmlFor="light-textarea">Message</Label>
            <Textarea
              id="light-textarea"
      ...
      <div className="dark border-border rounded-lg border-2 p-8">
        <div className="bg-primary/10 mb-6 rounded-md p-4">
          ...
          <p className="text-muted-foreground text-sm">Labels in dark theme</p>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="dark-premium">
              <Star className="size-4" />
              Premium
            </Label>
            <Input id="dark-premium" type="text" placeholder="Enter code" />
          </div>

          <div className="flex flex-col gap-2">
            <Label htmlFor="dark-required">
              Required Field
              <span className="text-destructive">*</span>
            </Label>
            <Input
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="dark-error">
              With Error
              <AlertCircle className="text-destructive size-4" />
            </Label>
            <Input id="dark-error" type="text" aria-invalid />
          </div>

          <div className="flex flex-col gap-2">
            <Label htmlFor="dark-textarea">Message</Label>
            <Textarea
              id="dark-textarea"
              placeholder="Enter message..."
              rows={3}
