...
function FullModalTrigger({
  ...props
}: React.ComponentProps<typeof DialogPrimitive.Trigger>) {
  return <DialogPrimitive.Trigger data-slot="dialog-trigger" {...props} />;
}

function FullModalPortal({
  ...props
}: React.ComponentProps<typeof DialogPrimitive.Portal>) {
  return <DialogPrimitive.Portal data-slot="dialog-portal" {...props} />;
}

function FullModalClose({
  ...props
}: React.ComponentProps<typeof DialogPrimitive.Close>) {
  return <DialogPrimitive.Close data-slot="dialog-close" {...props} />;
}

function FullModalOverlay({
  className,
  ...props
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        'data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-[rgba(16,16,16,0.30)] backdrop-blur-[70px]',
        className,
      )}
      {...props}
    />
...
function FullModalContent({
  ...
  return (
    <FullModalPortal data-slot="dialog-portal">
      <FullModalOverlay />
...
function FullModalHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
...
function FullModalFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
