    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
      ...
      <div className="light border-border rounded-lg border-2 p-8">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            <Label htmlFor="light-default">Default</Label>
            <Textarea
              id="light-default"
              placeholder="Type something..."
              rows={3}
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="light-with-value">With Value</Label>
            <Textarea
              id="light-with-value"
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="light-error">Error State</Label>
            <Textarea
              id="light-error"
              placeholder="Invalid input"
              rows={3}
      ...
      <div className="dark border-border rounded-lg border-2 p-8">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            <Label htmlFor="dark-default">Default</Label>
            <Textarea
              id="dark-default"
              placeholder="Type something..."
              rows={3}
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="dark-with-value">With Value</Label>
            <Textarea
              id="dark-with-value"
              defaultValue="This is some sample text in the textarea."
              rows={3}
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor="dark-error">Error State</Label>
            <Textarea
              id="dark-error"
              placeholder="Invalid input"
              rows={3}
